...
# How to run:
# python create_mapall-volume.py ip-to-mdm user pass volume_name protection_domain_name storage_pool_name
...
sio.create_volume(sys.argv[4], 8192, sio.get_pd_by_name(sys.argv[5]), sio.get_storage_pool_by_name(sys.argv[6]), mapAll=True)
